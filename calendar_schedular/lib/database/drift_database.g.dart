...
class CategoryColorData extends DataClass
  ...
  CategoryColorData({required this.id, required this.textCode});
  factory CategoryColorData.fromData(Map<String, dynamic> data,
      {String? prefix}) {
    final effectivePrefix = prefix ?? '';
    return CategoryColorData(
      id: const IntType()
          .mapFromDatabaseResponse(data['${effectivePrefix}id'])!,
      textCode: const StringType()
          .mapFromDatabaseResponse(data['${effectivePrefix}text_code'])!,
    );
  }
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
  ...
  CategoryColorData copyWith({int? id, String? textCode}) => CategoryColorData(
        id: id ?? this.id,
...
class CategoryColorCompanion extends UpdateCompanion<CategoryColorData> {
  ...
  CategoryColorCompanion copyWith({Value<int>? id, Value<String>? textCode}) {
    return CategoryColorCompanion(
      id: id ?? this.id,
      textCode: textCode ?? this.textCode,
    );
...
class $CategoryColorTable extends CategoryColor
  ...
  late final GeneratedColumn<int?> id = GeneratedColumn<int?>(
      ...
      requiredDuringInsert: false,
      defaultConstraints: 'PRIMARY KEY AUTOINCREMENT');
  final VerificationMeta _textCodeMeta = const VerificationMeta('textCode');
  @override
  ...
  CategoryColorData map(Map<String, dynamic> data, {String? tablePrefix}) {
    return CategoryColorData.fromData(data,
        prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
